...
public class MouseContro : MonoBehaviour {
    ...
    void Update()
    {
        ...
        Vector3 movementZ = Input.GetAxis("Mouse Y") * Vector3.forward * moveSpeed * Time.deltaTime;

        // Determine how much should move in the x-direction
        Vector3 movementX = Input.GetAxis("Mouse X") * Vector3.right * moveSpeed * Time.deltaTime;
